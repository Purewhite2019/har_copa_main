...
from common.utils import remove_comments, normalize_spaces, format_whole_solution_generation_prompt
...
def main(
    ...
    logger.info(f'Evaluating WG on {benchmark} with hyperparams: {saved_args}')
            ...
            try:
                ...
                response = (await solver_client.chat.completions.create(
                    ...
                    messages=[
                        ...
                        {"role": "user", "content": format_whole_solution_generation_prompt(sample.informal_problem, str(init_solving_state.goals[0]))},
                    ],
